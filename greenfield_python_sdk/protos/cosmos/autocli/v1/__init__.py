...
ModuleOptions.__pydantic_model__.update_forward_refs()  # type: ignore
ServiceCommandDescriptor.__pydantic_model__.update_forward_refs()  # type: ignore
RpcCommandOptions.__pydantic_model__.update_forward_refs()  # type: ignore
AppOptionsResponse.__pydantic_model__.update_forward_refs()  # type: ignore
