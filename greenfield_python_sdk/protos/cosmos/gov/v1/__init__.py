...
class GenesisState(betterproto.Message):
    ...
    def __post_init__(self) -> None:
        ...
        if self.is_set("deposit_params"):
            warnings.warn("GenesisState.deposit_params is deprecated", DeprecationWarning)
        if self.is_set("voting_params"):
            warnings.warn("GenesisState.voting_params is deprecated", DeprecationWarning)
...
class QueryParamsResponse(betterproto.Message):
    ...
    def __post_init__(self) -> None:
        super().__post_init__()
        if self.is_set("voting_params"):
            warnings.warn("QueryParamsResponse.voting_params is deprecated", DeprecationWarning)
        if self.is_set("deposit_params"):
            warnings.warn("QueryParamsResponse.deposit_params is deprecated", DeprecationWarning)
        if self.is_set("tally_params"):
            warnings.warn("QueryParamsResponse.tally_params is deprecated", DeprecationWarning)
...
@dataclass(eq=False, repr=False)
class MsgUpdateCrossChainParams(betterproto.Message):
...
class MsgStub(betterproto.ServiceStub):
    ...
    async def exec_legacy_content(
        self,
        msg_exec_legacy_content: "MsgExecLegacyContent",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
    ...
    async def update_cross_chain_params(
        self,
        msg_update_cross_chain_params: "MsgUpdateCrossChainParams",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            "/cosmos.gov.v1.Msg/UpdateCrossChainParams",
            msg_update_cross_chain_params,
            MsgUpdateCrossChainParamsResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
...
class MsgBase(ServiceBase):
    ...
    async def exec_legacy_content(
        self, msg_exec_legacy_content: "MsgExecLegacyContent"
    ) -> "MsgExecLegacyContentResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def update_cross_chain_params(
        self, msg_update_cross_chain_params: "MsgUpdateCrossChainParams"
    ) -> "MsgUpdateCrossChainParamsResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_exec_legacy_content(
        self,
        stream: "grpclib.server.Stream[MsgExecLegacyContent, MsgExecLegacyContentResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.exec_legacy_content(request)
        await stream.send_message(response)
    ...
    async def __rpc_update_cross_chain_params(
        self,
        stream: "grpclib.server.Stream[MsgUpdateCrossChainParams, MsgUpdateCrossChainParamsResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.update_cross_chain_params(request)
        await stream.send_message(response)
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            ...
            "/cosmos.gov.v1.Msg/UpdateParams": grpclib.const.Handler(
                self.__rpc_update_params,
                grpclib.const.Cardinality.UNARY_UNARY,
                MsgUpdateParams,
                MsgUpdateParamsResponse,
            ),
            "/cosmos.gov.v1.Msg/UpdateCrossChainParams": grpclib.const.Handler(
                self.__rpc_update_cross_chain_params,
                grpclib.const.Cardinality.UNARY_UNARY,
