...
@dataclass(eq=False, repr=False)
class MsgImpeach(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class MsgImpeachResponse(betterproto.Message):
...
class MsgStub(betterproto.ServiceStub):
    ...
    async def impeach(
        ...
        *,
        ...
        return await self._unary_unary(
            "/cosmos.slashing.v1beta1.Msg/Impeach",
            msg_impeach,
            MsgImpeachResponse,
            timeout=timeout,
            deadline=deadline,
...
class MsgBase(ServiceBase):
    ...
    async def impeach(self, msg_impeach: "MsgImpeach") -> "MsgImpeachResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_impeach(self, stream: "grpclib.server.Stream[MsgImpeach, MsgImpeachResponse]") -> None:
        request = await stream.recv_message()
        response = await self.impeach(request)
        await stream.send_message(response)
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            ...
            "/cosmos.slashing.v1beta1.Msg/Impeach": grpclib.const.Handler(
                self.__rpc_impeach,
                grpclib.const.Cardinality.UNARY_UNARY,
                MsgImpeach,
                MsgImpeachResponse,
