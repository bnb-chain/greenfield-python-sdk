...
class BucketInfo(betterproto.Message):
    ...
    tags: "ResourceTags" = betterproto.message_field(11)
...
class ObjectInfo(betterproto.Message):
    ...
    tags: "ResourceTags" = betterproto.message_field(15)
...
class GroupInfo(betterproto.Message):
    ...
    tags: "ResourceTags" = betterproto.message_field(6)
...
@dataclass(eq=False, repr=False)
class ResourceTags(betterproto.Message):
    tags: List["ResourceTagsTag"] = betterproto.message_field(1)
    """tags defines a list of tags the resource has"""


@dataclass(eq=False, repr=False)
class ResourceTagsTag(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class EventSetTag(betterproto.Message):
    ...
    tags: "ResourceTags" = betterproto.message_field(2)
...
@dataclass(eq=False, repr=False)
class MsgSetTag(betterproto.Message):
    operator: str = betterproto.string_field(1)
    ...
    tags: "ResourceTags" = betterproto.message_field(3)
    """tags defines a list of tags which will be set to the resource"""


@dataclass(eq=False, repr=False)
class MsgSetTagResponse(betterproto.Message):
    pass
...
class MsgBase(ServiceBase):
    ...
    async def set_tag(self, msg_set_tag: "MsgSetTag") -> "MsgSetTagResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_set_tag(self, stream: "grpclib.server.Stream[MsgSetTag, MsgSetTagResponse]") -> None:
        request = await stream.recv_message()
        response = await self.set_tag(request)
        await stream.send_message(response)
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            ...
            "/greenfield.storage.Msg/SetTag": grpclib.const.Handler(
                self.__rpc_set_tag,
                grpclib.const.Cardinality.UNARY_UNARY,
                MsgSetTag,
                MsgSetTagResponse,
