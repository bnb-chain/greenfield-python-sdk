...
class GlobalVirtualGroup(betterproto.Message):
    ...
    secondary SP. Every global virtual group must belong to a GVG family, and
    the objects of each bucket must be stored in a GVG within a group family.
    """
    ...
    """
    Secondary SP IDs represents the list of unique identifiers of the secondary
    storage providers in the group.
    """
    ...
    """
    Virtual payment address represents the payment address associated with the
    group.
    """

    total_deposit: str = betterproto.string_field(7)
    """
    Total deposit represents the number of tokens deposited by this storage
...
class GlobalVirtualGroupFamily(betterproto.Message):
    """
    Global virtual group family serve as a means of grouping global virtual
    groups. Each bucket must be associated with a unique global virtual group
    family and cannot cross families.
    """
    ...
    """
    global_virtual_group_ids is a list of identifiers of the global virtual
    groups associated with the family.
    """

    virtual_payment_address: str = betterproto.string_field(4)
    """
    virtual_payment_address is the payment address associated with the global
    virtual group family.
    """
...
class GlobalVirtualGroupsBindingOnBucket(betterproto.Message):
    ...
    """
    global_virtual_group_ids is a list of identifiers of the global virtual
    groups associated with the bucket.
    """

    local_virtual_group_ids: List[int] = betterproto.uint32_field(3)
    """
    local_virtual_group_ids is a list of identifiers of the local virtual
    groups associated with the bucket.
    """
...
class GvgStatisticsWithinSp(betterproto.Message):
    ...
    """
    storage_provider_id defines the id of the sp which the statistics
    associated to
    """

    primary_count: int = betterproto.uint32_field(2)
    """
    primary_sp_family_count defines the number of the family which this sp
    serves as primary sp
    """

    secondary_count: int = betterproto.uint32_field(3)
    """
    secondary_count defines the number of global virtual groups (GVGs) in which
    this storage provider serves as a secondary storage provider.
    """
...
class EventCreateGlobalVirtualGroup(betterproto.Message):
    ...
    virtual_payment_address: str = betterproto.string_field(6)
    """
    The virtual payment address of this global virtual group, which is auto
    generated by blockchain And, all users' payment flows will flow to this
    account
    """
...
class EventUpdateGlobalVirtualGroup(betterproto.Message):
    ...
    """
    Primary SP ID represents the unique id of the primary storage provider in
    the group.
    """
...
class EventCreateGlobalVirtualGroupFamily(betterproto.Message):
    id: int = betterproto.uint32_field(1)
    """
    The id of global virtual group family, which is auto generated by
    blockchain
    """
    ...
    """
    The virtual payment address of this global virtual group family, which is
    auto generated by blockcahin all users' read quota payment flows will flow
    to this account.
    """
...
class EventSwapOut(betterproto.Message):
    ...
    """
    The id of the gvg family which the storage provider wants to swap out as
    primary sp
    """

    global_virtual_group_ids: List[int] = betterproto.uint32_field(3)
    """
    The ids of the gvgs which the storage provider wants to swap out as
    secondary sp
    """
...
class Params(betterproto.Message):
    ...
    """
    if the store size reach the exceed, the family is not allowed to sever more
    buckets
    """
...
class GenesisState(betterproto.Message):
    """
    GenesisState defines the virtualgroup module's genesis state. GenesisState
    defines the raw genesis transaction in JSON.
    """
...
class MsgUpdateParams(betterproto.Message):
    ...
    """
    params defines the x/virtualgroup parameters to update. NOTE: All
...
class MsgCreateGlobalVirtualGroup(betterproto.Message):
    ...
    """
    storage_provider defines the operator account address of the storage
    provider who create the global virtual group.
    """
    ...
    """
    secondary_sp_id is a list of secondary storage provider IDs associated with
    the virtual group.
    """
...
class MsgDeleteGlobalVirtualGroup(betterproto.Message):
    ...
    """
    storage_provider defines the operator account address of the storage
    provider who delete the global virtual group.
    """
...
class MsgDeposit(betterproto.Message):
    storage_provider: str = betterproto.string_field(1)
    """
    storage_provider defines the operator/funding account address of the
    storage provider who deposit to the global virtual group.
    """
    ...
    """
    deposit is the amount of tokens being deposited for the global virtual
    group.
    """
...
class MsgWithdraw(betterproto.Message):
    ...
    """
    storage_provider defines the operator/funding account address of the
    storage provider who withdraw from the global virtual group.
    """
    ...
    """
    withdraw is the amount of coins to be withdrawn. The amount needs to be
    smaller than stored_size * storage_staking_price
    """
...
class MsgSwapOut(betterproto.Message):
    ...
    """
    storage_provider defines the operator account address of the storage
    provider who want to swap out from the global virtual group.
    """

    global_virtual_group_family_id: int = betterproto.uint32_field(2)
    """
    virtual_group_family_id is the identifier of the virtual group family. if
    it set to non-zero, it represents that the operator swap out as the primary
    storage provider it it set to zero, it represents that the operator swap
    out as the secondary storage provider.
    """

    global_virtual_group_ids: List[int] = betterproto.uint32_field(3)
    """
    global_virtual_group_ids is a list of global virtual group IDs associated
    with the swap out. It allows to be empty only when the operator is the
    ...
    """
    approval includes an expiration time and a signature. The fields to be
    signed with contains the necessary information of the successor.
    """
...
class MsgCompleteSwapOut(betterproto.Message):
    ...
    """
    storage_provider defines the operator account address of the storage
    provider who complete swap out task.
    """
...
class MsgCancelSwapOut(betterproto.Message):
    ...
    """
    storage_provider defines the operator account address of the storage
    provider who cancel the swap out task.
    """
...
class MsgSettle(betterproto.Message):
    """
    MsgSettle define the message for settling storage income of GVG family or
    several GVGs. Firstly, the handler will do stream settlement for the
    payment account; and secondly, the income will be distributed to related
    storage providers.
    """
    ...
    """
    storage_provider defines the operator/funding account address of the
    storage provider who initial settle request.
    """

    global_virtual_group_family_id: int = betterproto.uint32_field(2)
    """
    global_virtual_group_family_id is the identifier of the global virtual
    group family.
    """
...
class MsgStorageProviderExit(betterproto.Message):
    ...
    """
    storage_provider defines the operator account address of the storage
    provider who want to exit from the greenfield storage network.
    """
...
class QueryStub(betterproto.ServiceStub):
    ...
    async def global_virtual_group_by_family_id(
        self,
        query_global_virtual_group_by_family_id_request: "QueryGlobalVirtualGroupByFamilyIdRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
...
QueryGlobalVirtualGroupResponse.__pydantic_model__.update_forward_refs()  # type: ignore
QueryGlobalVirtualGroupByFamilyIdResponse.__pydantic_model__.update_forward_refs()  # type: ignore
QueryGlobalVirtualGroupFamilyResponse.__pydantic_model__.update_forward_refs()  # type: ignore
QueryGlobalVirtualGroupFamiliesRequest.__pydantic_model__.update_forward_refs()  # type: ignore
QueryGlobalVirtualGroupFamiliesResponse.__pydantic_model__.update_forward_refs()  # type: ignore
MsgUpdateParams.__pydantic_model__.update_forward_refs()  # type: ignore
MsgCreateGlobalVirtualGroup.__pydantic_model__.update_forward_refs()  # type: ignore
MsgDeposit.__pydantic_model__.update_forward_refs()  # type: ignore
MsgWithdraw.__pydantic_model__.update_forward_refs()  # type: ignore
MsgSwapOut.__pydantic_model__.update_forward_refs()  # type: ignore
