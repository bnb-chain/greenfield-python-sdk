...
class RequestBeginBlock(betterproto.Message):
    ...
    last_commit_info: "CommitInfo" = betterproto.message_field(3)
    byzantine_validators: List["Misbehavior"] = betterproto.message_field(4)
...
@dataclass(eq=False, repr=False)
class RequestEthQuery(betterproto.Message):
    """Eth json rpc query request"""

    request: bytes = betterproto.bytes_field(1)
...
@dataclass(eq=False, repr=False)
class ResponseEthQuery(betterproto.Message):
    code: int = betterproto.uint32_field(1)
...
class AbciApplicationStub(betterproto.ServiceStub):
    ...
    async def eth_query(
        self,
        request_eth_query: "RequestEthQuery",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            "/tendermint.abci.ABCIApplication/EthQuery",
            request_eth_query,
            ResponseEthQuery,
            timeout=timeout,
            deadline=deadline,
...
class AbciApplicationBase(ServiceBase):
    ...
    async def deliver_tx(self, request_deliver_tx: "RequestDeliverTx") -> "ResponseDeliverTx":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def init_chain(self, request_init_chain: "RequestInitChain") -> "ResponseInitChain":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def begin_block(self, request_begin_block: "RequestBeginBlock") -> "ResponseBeginBlock":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def end_block(self, request_end_block: "RequestEndBlock") -> "ResponseEndBlock":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def list_snapshots(self, request_list_snapshots: "RequestListSnapshots") -> "ResponseListSnapshots":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def offer_snapshot(self, request_offer_snapshot: "RequestOfferSnapshot") -> "ResponseOfferSnapshot":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def prepare_proposal(self, request_prepare_proposal: "RequestPrepareProposal") -> "ResponsePrepareProposal":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def process_proposal(self, request_process_proposal: "RequestProcessProposal") -> "ResponseProcessProposal":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_flush(self, stream: "grpclib.server.Stream[RequestFlush, ResponseFlush]") -> None:
        request = await stream.recv_message()
        response = await self.flush(request)
        await stream.send_message(response)

    async def __rpc_info(self, stream: "grpclib.server.Stream[RequestInfo, ResponseInfo]") -> None:
        request = await stream.recv_message()
        response = await self.info(request)
        await stream.send_message(response)

    async def __rpc_deliver_tx(self, stream: "grpclib.server.Stream[RequestDeliverTx, ResponseDeliverTx]") -> None:
        request = await stream.recv_message()
        response = await self.deliver_tx(request)
        await stream.send_message(response)

    async def __rpc_check_tx(self, stream: "grpclib.server.Stream[RequestCheckTx, ResponseCheckTx]") -> None:
        request = await stream.recv_message()
        response = await self.check_tx(request)
        await stream.send_message(response)

    async def __rpc_query(self, stream: "grpclib.server.Stream[RequestQuery, ResponseQuery]") -> None:
        request = await stream.recv_message()
        response = await self.query(request)
        await stream.send_message(response)

    async def __rpc_commit(self, stream: "grpclib.server.Stream[RequestCommit, ResponseCommit]") -> None:
        request = await stream.recv_message()
        response = await self.commit(request)
        await stream.send_message(response)

    async def __rpc_init_chain(self, stream: "grpclib.server.Stream[RequestInitChain, ResponseInitChain]") -> None:
        request = await stream.recv_message()
        response = await self.init_chain(request)
        await stream.send_message(response)

    async def __rpc_begin_block(self, stream: "grpclib.server.Stream[RequestBeginBlock, ResponseBeginBlock]") -> None:
        request = await stream.recv_message()
        response = await self.begin_block(request)
        await stream.send_message(response)

    async def __rpc_end_block(self, stream: "grpclib.server.Stream[RequestEndBlock, ResponseEndBlock]") -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_eth_query(self, stream: "grpclib.server.Stream[RequestEthQuery, ResponseEthQuery]") -> None:
        request = await stream.recv_message()
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            ...
            "/tendermint.abci.ABCIApplication/EthQuery": grpclib.const.Handler(
                self.__rpc_eth_query,
                grpclib.const.Cardinality.UNARY_UNARY,
                RequestEthQuery,
                ResponseEthQuery,
            ),
