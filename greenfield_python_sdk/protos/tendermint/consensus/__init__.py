...
class NewValidBlock(betterproto.Message):
    ...
    i.e., there is a Proposal for block B and 2/3+ prevotes for the block B in the round
    r.
...
class WalMessage(betterproto.Message):
    event_data_round_state: "_types__.EventDataRoundState" = betterproto.message_field(1, group="sum")
