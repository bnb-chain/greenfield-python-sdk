...
@dataclass(eq=False, repr=False)
class Reveal(betterproto.Message):
...
class Evidence(betterproto.Message):
    duplicate_vote_evidence: Optional["DuplicateVoteEvidence"] = betterproto.message_field(
        1, optional=True, group="sum"
    )
    light_client_attack_evidence: Optional["LightClientAttackEvidence"] = betterproto.message_field(
        2, optional=True, group="sum"
    )
...
ValidatorSet.__pydantic_model__.update_forward_refs()  # type: ignore
Validator.__pydantic_model__.update_forward_refs()  # type: ignore
SimpleValidator.__pydantic_model__.update_forward_refs()  # type: ignore
Part.__pydantic_model__.update_forward_refs()  # type: ignore
BlockId.__pydantic_model__.update_forward_refs()  # type: ignore
Header.__pydantic_model__.update_forward_refs()  # type: ignore
Vote.__pydantic_model__.update_forward_refs()  # type: ignore
Commit.__pydantic_model__.update_forward_refs()  # type: ignore
CommitSig.__pydantic_model__.update_forward_refs()  # type: ignore
Proposal.__pydantic_model__.update_forward_refs()  # type: ignore
SignedHeader.__pydantic_model__.update_forward_refs()  # type: ignore
LightBlock.__pydantic_model__.update_forward_refs()  # type: ignore
BlockMeta.__pydantic_model__.update_forward_refs()  # type: ignore
TxProof.__pydantic_model__.update_forward_refs()  # type: ignore
ConsensusParams.__pydantic_model__.update_forward_refs()  # type: ignore
EvidenceParams.__pydantic_model__.update_forward_refs()  # type: ignore
Evidence.__pydantic_model__.update_forward_refs()  # type: ignore
DuplicateVoteEvidence.__pydantic_model__.update_forward_refs()  # type: ignore
LightClientAttackEvidence.__pydantic_model__.update_forward_refs()  # type: ignore
EvidenceList.__pydantic_model__.update_forward_refs()  # type: ignore
